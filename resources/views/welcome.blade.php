...
<body
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                class="text-[14px] leading-[22px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">

                <h1 class="mb-2 font-bold text-xl text-gray-900 dark:text-white">Welcome to Our Product</h1>

                <p class="mb-4 text-gray-700 dark:text-[#CFCFCF]">
                    Our platform helps you analyze and visualize your sales data efficiently.
                    Explore trends, top products, regions, and get AI-powered insights to grow your business.
                </p>
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="{{ route('login') }}"
                        class="px-5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-sm transition text-center">
                        Login
                    </a>
                </div>
